...
public class DirectMappingTest {
	private static final String TEST_SUITE_DIR = "src/test/rdb2rdf-tests/";
	...
	public static Collection<Object[]> getTestLists() {
		...
		for (File f: new File(TEST_SUITE_DIR).listFiles()) {
			...
			if (Arrays.asList(D2RQTestUtil.SKIPPED_DIRECT_MAPPING_TESTS).contains(f.getName())) continue;
